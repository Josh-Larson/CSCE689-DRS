...
# Load Data
print("Loading data...")
imgL = cv2.cvtColor(cv2.imread('../../12_Dec_19/approach1/EO/3L_eo.bmp'), cv2.COLOR_RGB2GRAY)
imgR = cv2.cvtColor(cv2.imread('../../12_Dec_19/approach1/EO/3R_eo.bmp'), cv2.COLOR_RGB2GRAY)
